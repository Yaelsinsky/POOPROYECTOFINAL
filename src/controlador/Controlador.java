...
public class Controlador {
 ...
 public static void main(String[] args) {
   ...
   private static void modificarDatosAlumno() {
    ...
    /**
     * Elimina los datos de un alumno especificado por el usuario. 
     * Pide al usuario el número de cuenta del alumno a eliminar.
     */
    private static void eliminarDatosAlumno() {
    // Implementar lógica para eliminar datos de un alumno
    Scanner scanner = new Scanner(System.in);
    System.out.print("Ingrese el numero de cuenta del alumno que desea eliminar: ");
    String numeroCuenta = scanner.nextLine();

    // Aquí debes agregar la lógica real para eliminar datos de un alumno
    // Por ahora, simplemente mostramos un mensaje de simulación
    System.out.println("Eliminando datos del alumno con numero de cuenta: " + numeroCuenta);
}
